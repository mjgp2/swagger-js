...
var Operation = module.exports = function (parent, scheme, operationId, httpMethod, path, args, definitions, models, clientAuthorizations) {
  ...
  for (i = 0; i < this.parameters.length; i++) {
    ...
    param.sampleRequestJSON = this.getModelSampleJSON(innerType, this.models, true);
 ...
 **/
Operation.prototype.getModelSampleJSON = function (type, models, forRequest) {
  var isPrimitive, listType, sampleJson;

  listType = (type instanceof Array);
  isPrimitive = models[type] ? false : true;
  sampleJson = isPrimitive ? void 0 : models[type].createJSONSample(null, forRequest);
